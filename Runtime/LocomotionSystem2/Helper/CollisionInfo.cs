namespace Cat.LocomotionSystem
{
    ...
    public class CollisionInfo
    {
        ...
        )
        {
            ...
            this.isAnEdge = edgeAngle >= CharacterConstants.MinEdgeAngle && edgeAngle <= CharacterConstants.MaxEdgeAngle;
            this.isAStep = edgeAngle >= CharacterConstants.MinStepAngle && edgeAngle <= CharacterConstants.MaxStepAngle;
        }
