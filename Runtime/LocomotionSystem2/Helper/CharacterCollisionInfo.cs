namespace Cat.LocomotionSystem
{
    ...
    public struct CharacterCollisionInfo
    {
        ...
        public void SetWallInfo(in Contact contact, BuiltinLocomotionSystem1 characterActor)
        {
            wallCollision = true;
        ...
        public void SetHeadInfo(in Contact contact, BuiltinLocomotionSystem1 characterActor)
        {
            headCollision = true;
        ...
        public void SetGroundInfo(in CollisionInfo collisionInfo, BuiltinLocomotionSystem1 characterActor, bool setGroundContact)
        {
        ...
        void SetGroundContact(in CollisionInfo collisionInfo, BuiltinLocomotionSystem1 characterActor)
        {
            if (!collisionInfo.hitInfo.hit)
                return;
