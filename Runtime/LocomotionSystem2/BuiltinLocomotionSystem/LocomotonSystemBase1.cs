namespace Cat.LocomotionSystem
{
    ...
    /// </summary>
    public abstract class LocomotionSystemBase1 : MonoBehaviour
    {
        [Header("Rigidbody")]
        ...
        public void InterpolateBody()
        {
            ...
            if (wasInterpolatingActor)
            {
                ...
                transform.SetPositionAndRotation(resetPositionFlag ? targetPosition : Vector3.Lerp(startingPosition, targetPosition, interpolationFactor), resetRotationFlag ? targetRotation : Quaternion.Slerp(startingRotation, targetRotation, interpolationFactor));
            }
